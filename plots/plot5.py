...
def main():
    ...
    plt.ylabel('PE(%)',font={'size':8})
    # plt.legend(loc=2, bbox_to_anchor=(1, 1.0),ncol=1)
    plt.legend()
    plt.savefig(f'plot5.jpg',bbox_inches='tight',dpi=720,pad_inches=0.01)
    plt.savefig(f'plot5.pdf',bbox_inches='tight',dpi=720,pad_inches=0.01)
