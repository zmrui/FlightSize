...
class mn_network:
    ...
    def disable_tso(self):
        ...
        print(self.h1.cmd("ethtool -K h1-eth0 tx off sg off tso off gso off"))
        print(self.h2.cmd("ethtool -K h2-eth0 tx off sg off tso off gso off"))
        print(self.h3.cmd("ethtool -K h3-eth0 tx off sg off tso off gso off"))
        print(self.h3.cmd("ethtool -K h3-eth1 tx off sg off tso off gso off"))
